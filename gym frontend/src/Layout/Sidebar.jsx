...
const Sidebar = ({ collapsed, setCollapsed }) => {
  ...
  const allMenus = {
    ...
    SUBADMIN: [
      ...
      { name: "Leads / Inquiries", icon: faAddressBook, path: "/sales/leads", module: "Leads / Inquiries" },
      { name: "Branches", icon: faCodeBranch, path: "/admin/AdminBranches", module: "Branches" },
    ...
    RECEPTIONIST: [
      ...
      { name: "Payments & Invoicing", icon: faMoneyCheckAlt, path: "/sales/payemnet" },
      { name: "Staff Salary", icon: faUserTie, path: "/staff/salary-calculator" },
