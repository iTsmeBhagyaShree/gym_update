        ...
        <div className="col-12 col-xl-11">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
            ...
            <span className="badge bg-primary fs-6 py-2 px-3">
              Goal: {assessment.inputs.fitness_goal.replace('_', ' ').toUpperCase()}
            </span>
          </div>
                ...
                <div className="card-body">
                  ...
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item d-flex justify-content-between px-0">
                      ...
                      <strong>{assessment.metrics.bmi} <span className="badge bg-light text-dark border ms-1">{assessment.dashboard_data.bmi_risk_label}</span></strong>
                    </li>
                    <li className="list-group-item d-flex justify-content-between px-0">
                      <span className="text-muted">Body Fat</span>
                      <strong>{assessment.metrics.body_fat_percentage}%</strong>
                    </li>
                    <li className="list-group-item d-flex justify-content-between px-0">
                      <span className="text-muted">Lean Mass</span>
                      <strong>{assessment.metrics.lean_body_mass} kg</strong>
                    </li>
                    <li className="list-group-item d-flex justify-content-between px-0">
                      <span className="text-muted">Ideal Weight</span>
                      <strong>{assessment.metrics.ideal_body_weight} kg</strong>
                    </li>
                    {assessment.metrics.waist_to_hip_ratio && (
                      <li className="list-group-item d-flex justify-content-between px-0">
                        <span className="text-muted">WHR</span>
                        <strong>{assessment.metrics.waist_to_hip_ratio}</strong>
                      </li>
                    )}
                  </ul>
                </div>
                ...
                <div className="card-body">
                  ...
                  <ul className="list-group list-group-flush mb-3">
                    <li className="list-group-item d-flex justify-content-between px-0">
                      ...
                      <strong>{assessment.metrics.bmr} kcal</strong>
                    </li>
                    <li className="list-group-item d-flex justify-content-between px-0">
                      <span className="text-muted">TDEE (Active)</span>
                      <strong>{assessment.metrics.tdee} kcal</strong>
                    </li>
                  </ul>
                  <div className="p-3 bg-warning bg-opacity-10 rounded text-center mt-auto border border-warning border-opacity-25">
                    ...
                    <div className="fs-3 fw-bold text-dark">{assessment.metrics.target_calories} <span className="fs-6 text-muted fw-normal">kcal</span></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card h-100 shadow-sm border-0 border-top border-success border-4 rounded-3">
                <div className="card-body">
                  ...
                  <div className="d-flex justify-content-between align-items-center p-2 mb-2 bg-danger bg-opacity-10 rounded border border-danger border-opacity-25">
                    ...
                    <strong className="text-danger fs-5">{assessment.macros.protein_grams}g</strong>
                  </div>
                  ...
                  <div className="d-flex justify-content-between align-items-center p-2 mb-2 bg-warning bg-opacity-10 rounded border border-warning border-opacity-25">
                    ...
                    <strong className="text-warning text-dark fs-5">{assessment.macros.fat_grams}g</strong>
                  </div>
                  ...
                  <div className="d-flex justify-content-between align-items-center p-2 rounded bg-info bg-opacity-10 border border-info border-opacity-25">
                    ...
                    <strong className="text-info text-dark fs-5">{assessment.macros.carb_grams}g</strong>
                  </div>
                ...
                <div className="card-body">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="d-flex align-items-center">
                      <h3 className="text-danger mb-0 me-2">{assessment.dashboard_data.cardio_zones.fat_burn_low}</h3>
                      <span className="text-muted mx-1">-</span>
                      <h3 className="text-danger mb-0 ms-2">{assessment.dashboard_data.cardio_zones.fat_burn_high}</h3>
                  ...
                  <div>
                    ...
                    <div className="d-flex align-items-center">
                      <h3 className="text-dark mb-0 me-2">{assessment.dashboard_data.cardio_zones.cardio_low}</h3>
                      <span className="text-muted mx-1">-</span>
                      <h3 className="text-dark mb-0 ms-2">{assessment.dashboard_data.cardio_zones.cardio_high}</h3>
                      <span className="ms-2 text-muted small">BPM</span>
                    </div>
                  </div>
