                    ...
                    <div key={plan.id} className="col-12 col-md-4 mb-4">
                      <div className="card h-100 shadow-sm border-0 border-top border-primary border-4">
                        <div className="card-body">
                          <h5 className="card-title fw-bold text-primary">{plan.name}</h5>
                          <h3 className="fw-bold my-3">₹{plan.price}</h3>
                          <div className="mb-3">
                            <span className="badge bg-light text-dark border me-2">Duration: {plan.duration} Days</span>
                            {plan.tax && <span className="badge bg-light text-dark border">Tax: {plan.tax}%</span>}
                          </div>
                          {plan.description && <p className="text-muted small">{plan.description}</p>}
                        </div>
                      </div>
                    </div>
                  ))}
