            ...
            >
              <ErrorBoundary>
                <Routes>
                  ...
                  <Route path="/admin/AdminMember" element={<ProtectedRoute allowedRoles={["ADMIN", "SUPERADMIN", "GENERAL TRAINER", "PERSONAL TRAINER"]}><AdminMember /></ProtectedRoute>} />
                  ...
                  <Route path="/sales/dashboard" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReceptionistDashboard /></ProtectedRoute>} />
                  <Route path="/sales/leads" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN", "SUBADMIN"]}><Leads /></ProtectedRoute>} />
                  <Route path="/sales/walk-in-registration" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReceptionistWalkinMember /></ProtectedRoute>} />
                  <Route path="/sales/new-sign-ups" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReceptionistMembershipSignups /></ProtectedRoute>} />
                  <Route path="/sales/qr-attendance" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReceptionistQRCode /></ProtectedRoute>} />
                  <Route path="/sales/qrcheckin" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReceptionistQrCheckin /></ProtectedRoute>} />
                  <Route path="/sales/book-classes-sessions" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReceptionistBookGroupClasses /></ProtectedRoute>} />
                  <Route path="/sales/payemnet" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReceptionistPaymentCollection /></ProtectedRoute>} />
                  <Route path="/sales/reportattendance" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReportsAttendance /></ProtectedRoute>} />
                  <Route path="/sales/report-attendance-checkout" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReceptionistHouseKeepingAttendanceCheckOut /></ProtectedRoute>} />
                  <Route path="/sales/report" element={<ProtectedRoute allowedRoles={["RECEPTIONIST", "ADMIN", "SUPERADMIN"]}><ReportsClasses /></ProtectedRoute>} />
                  ...
                  <Route path="/personaltrainer/assessment-form" element={<ProtectedRoute allowedRoles={["PERSONALTRAINER", "ADMIN", "SUPERADMIN"]}><TrainerAssessmentForm /></ProtectedRoute>} />
                  <Route path="/personaltrainer/client-progress" element={<ProtectedRoute allowedRoles={["PERSONALTRAINER", "ADMIN", "SUPERADMIN"]}><ClientAssessmentList /></ProtectedRoute>} />
                  <Route path="/personaltrainer/member-assessment/:memberId" element={<ProtectedRoute allowedRoles={["PERSONALTRAINER", "ADMIN", "SUPERADMIN"]}><MemberAssessmentWrapper /></ProtectedRoute>} />
