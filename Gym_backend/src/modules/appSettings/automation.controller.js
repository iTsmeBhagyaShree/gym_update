...
export const updateAutomationSettings = async (req, res, next) => {
  try {
    const { trialDurationDays, gracePeriodDays, enableEmailNotif, enableWhatsappNotif } = req.body;
    
    await pool.query(`
      UPDATE automation_settings 
      SET trialDurationDays = ?, gracePeriodDays = ?, enableEmailNotif = ?, enableWhatsappNotif = ?
    `, [trialDurationDays, gracePeriodDays, enableEmailNotif, enableWhatsappNotif]);
