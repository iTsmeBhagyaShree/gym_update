      ...
      <div className="col-12 col-xl-5">
        <div className="card border-0 shadow-sm p-4 bg-white" style={{ borderRadius: "15px" }}>
          ...
          <form onSubmit={handleBroadcast}>
            ...
            {/* Optional Image */}
            <div className="mb-4">
              <label htmlFor="image" className="form-label fw-bold text-secondary">Attach Image (Optional)</label>
              <input type="file" className="form-control shadow-sm" id="image" accept="image/*"
