...
const exportMembersToPDF = async () => {
  ...
  // ✅ Subscription Plan Badge (Basic / Growth / Premium)
              ...
              <table className="table align-middle mb-0" style={{ tableLayout: "fixed", width: "100%" }}>
                ...
                <thead style={{ background: "#F8F9FB" }}>
                  <tr>
                    ...
                    <th className="py-3" style={{ whiteSpace: "nowrap", fontSize: "0.75rem", color: "#6B7280", fontWeight: "600", letterSpacing: "0.04em" }}>BRANCH</th>
                  ...
                  {admins.length === 0 ? (
                    ...
                    admins.map((admin) => (
                      ...
                      >
                        ...
                        <td style={{ fontSize: "0.855rem" }}>{getSubscriptionBadge(admin.subscriptionPlan)}</td>
                        ...
                        <td style={{ fontSize: "0.855rem", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{getBranchNameById(admin.branchId)}</td>
                        ...
                        <td style={{ fontSize: "0.855rem" }}><span className="badge bg-info text-dark">{admin.tax || "5"}%</span></td>
                    ...
                    <div className="card-body p-3">
                      ...
                      <div className="row g-2 mb-2">
                        ...
                        <div className="col-6">
                          ...
                          {getSubscriptionBadge(admin.subscriptionPlan)}
                        </div>
