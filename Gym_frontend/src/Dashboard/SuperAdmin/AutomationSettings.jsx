...
import { faCogs, faEnvelope, faClock, faSave, faEdit, faCheckCircle, faPlus, faTrash, faRobot } from '@fortawesome/free-solid-svg-icons';
...
const AutomationSettings = () => {
  ...
  const [editingPkg, setEditingPkg] = useState({ packageName: '', credits: 0, price: 0, isActive: true });
  ...
  const openPkgModal = (pkg = null) => {
    if (pkg) {
      ...
      setEditingPkg({ packageName: '', credits: 0, price: 0, isActive: true });
    }
    ...
    <div className="container-fluid p-3 p-md-4" style={{ backgroundColor: '#f4f7f6', minHeight: '100vh', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="card shadow-sm border-0 rounded-4 mb-4">
        <div className="card-header bg-white border-bottom p-4 d-flex justify-content-between align-items-center">
          ...
          <button className="btn btn-success shadow-sm fw-bold rounded-pill px-4" onClick={() => openPkgModal()}>
              ...
              <div className="col-md-6 col-lg-3" key={p.id}>
                <div className="pricing-card">
                  ...
                  <div className="credits-badge">
                    <FontAwesomeIcon icon={faEnvelope} className="me-1" /> {p.credits.toLocaleString()} Credits
                  </div>
